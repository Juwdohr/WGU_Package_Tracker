...
class MyTestCase(unittest.TestCase):
    ...
    def test_Package_creation(self):
        ...
        self.assertEqual(self.package_6.status, "Delayed")
        self.assertEqual(self.package_9.status, "Delayed")

    def test_update_address(self):
        self.package_9.delivery_address = "410 S State St, Salt Lake City, UT 84111"
